...
!(function (e, t) {
  ...
  function M(e) {
    ...
    const c =
        'touchmove' === p.type && p.targetTouches && (p.targetTouches[0] || p.changedTouches[0]),
          ...
          setTranslate: () => {
            ...
            for (let e = 0; e < a.length; e += 1) {
              ...
              if (
                ...
                0 === e.length &&
                  ((e = d(`<div class="swiper-slide-shadow-${c ? 'left' : 'top'}"></div>`)),
                  t.append(e)),
                  0 === s.length &&
                    ((s = d(`<div class="swiper-slide-shadow-${c ? 'right' : 'bottom'}"></div>`)),
                    t.append(s)),
          ...
          setTranslate: () => {
            ...
            for (let l = 0; l < t.length; l += 1) {
              ...
              let f = 1,
                ...
                v = 8 - 0.75 * Math.abs(p)
              const w =
                  (l === s || l === s - 1) && p > 0 && p < 1 && (r || e.params.cssMode) && n < i,
