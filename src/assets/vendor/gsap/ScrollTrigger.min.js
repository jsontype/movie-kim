    ...
    F = function _updateAll() {
      if (!h) {
        ...
        if (
          ...
          (D = n),
          r &&
            (je && !Ie && 200 < t - je && ((je = 0), A("scrollEnd")),
            (Ae = m),
            (m = t)),
          ut < 0)
        ) {
          ...
          (we.refresh = function (e, t) {
            if ((!Be && we.enabled) || t)
              if (ae && e && je) Ca(ScrollTrigger, "scrollEnd", Va);
                ...
                for (
                  E =
                    mb(x, ie, p, re, we.scroll(), B, L, we, d, ye, me, g) ||
                    (ae ? -0.001 : 0),
                    W(m) && (m = m(we)),
                    V(m) &&
                      !m.indexOf("+=") &&
          ...
          (we.update = function (e, t) {
            ...
            if (
              (t &&
                ((_ = k),
                (k = s),
                pe && ((x = b), (b = M && !ge ? M.totalProgress() : c))),
              ce &&
                !c &&
                ae &&
                !Be &&
