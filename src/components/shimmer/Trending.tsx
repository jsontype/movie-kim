                ...
                <Placeholder as="p" animation="wave">
                  ...
                  >
                    <Col style={{ marginLeft: '3em', marginTop: '17em' }}>
                      ...
                      <Row style={{ marginTop: '2em' }}>
                        <Placeholder as="p" animation="glow">
                          <Placeholder style={{ height: 20, width: 470 }} /> <br />
                          <Placeholder style={{ height: 20, width: 440 }} /> <br />
                          <Placeholder style={{ height: 20, width: 410 }} />
                        </Placeholder>
                      </Row>
                      <Row style={{ marginTop: '1em' }}>
                        <Placeholder as="p" animation="glow">
                          <Placeholder bg="btn btn-hover" style={{ height: 45, width: 150 }} />
                        </Placeholder>
                      </Row>
                      <Row style={{ marginTop: '1em' }}>
                        <Placeholder as="p" animation="glow">
                          <Placeholder style={{ height: 16, width: 90 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 220 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 190 }} /> <br />
                          <Placeholder style={{ height: 16, width: 90 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 190 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 160 }} /> <br />
                          <Placeholder style={{ height: 16, width: 90 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 160 }} />{' '}
                          <Placeholder style={{ marginLeft: 7, height: 16, width: 130 }} />
                        </Placeholder>
                      </Row>
                    </Col>
                  </Placeholder>
