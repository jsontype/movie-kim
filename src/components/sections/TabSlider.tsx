    ...
    <Fragment>
      <div className="tab-slider">
        <div className="slider">
          ...
          >
            {tabSlider.map(data => (
              <SwiperSlide tag="li" className="tab-slider-banner" key={data.image}>
                    ...
                    <div className="row align-items-center min-vh-100 h-100 my-4">
                        ...
                        <div className="tab-left-details">
                          <div className="d-flex align-items-center gap-3 mb-4">
                            ...
                            <h5 className="text-gold">
                              <span className="text-primary">#4</span> {data.movieTime}
                            </h5>
                          </div>
                          <h1 className="mb-2 fw-500 text-capitalize texture-text">{data.title}</h1>
                          <p className="mb-0 font-size-14 line-count-2">
                            Sand and dust storms (SDS), also known as sirocco, haboob, yellow dust,
                            white storms, and the harmattan, are a natural phenomenon linked with
                            land
                          </p>
                      ...
                      <div className="col-md-6 col-lg-5 col-xxl-4 mt-5 mt-md-0">
                        <div className="tab-block">
                          <h4 className="tab-title text-capitalize mb-0">All Episode</h4>
                          <div className="tab-bottom-bordered border-0 trending-custom-tab">
                            <Tab.Container id="left-tabs-example" defaultActiveKey="0season">
                              <Nav
                                variant="pills"
                              ...
                              <Tab.Content className="tab-content trending-content">
                                {data.seasons.map((episodes, index) => (
                                  <Tab.Pane eventKey={index + 'season'} key={index + 'season'}>
                                        ...
                                        >
                                          ...
                                          <div className="image-details">
                                            <h6 className="mb-1 text-capitalize">
                                              <span className="text-primary">E{index + 1}</span> -{' '}
                                              {episode.title}
                                            </h6>
