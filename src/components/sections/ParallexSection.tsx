            ...
            <div className="col-xl-5 col-lg-12 col-md-12 r-mb-23">
              <div className="text-start">
                ...
                <p className="line-count-2 w-75 mb-5">
                  Baileys Irish Cream is an Irish cream liqueur an alcoholic beverage flavoured with
                  cream, cocoa, and Irish whiskey made by Diageo at Republic of Ireland and in
