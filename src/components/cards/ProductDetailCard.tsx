            ...
            <Col lg="6">
              <div className="product-tab-slider">
                ...
                <Swiper
                  thumbs={{
                    swiper:
                      thumbsSwiper && typeof thumbsSwiper !== 'function' ? thumbsSwiper : null,
                  }}
                  freeMode={true}
                  watchSlidesProgress={true}
            ...
            <Col lg="6" className="mt-lg-0 mt-5 ps-lg-5">
              ...
              <div className="product-meta-wrapper">
                <ul className="list-inline m-0 p-0">
                  ...
                  <li className="mb-2">
                    <span className="text-white fw-semibold">Categories : </span>
                    {props.category.map((item: any, index: any) => {
                      return (
                        <h6 className="d-inline text-primary text-capitalize" key={index}>
                          {' '}
                          {item},{' '}
                        </h6>
                      )
            ...
            <div className="product-detail-tab">
              <Tab.Container defaultActiveKey="first">
                ...
                <Tab.Content className="tab-content">
                  ...
                  <Tab.Pane id="additional-info" eventKey="second" className="fade">
                        ...
                        <li className="pb-5 mb-5 border-bottom">
                          <div className="d-flex flex-sm-row flex-column align-items-sm-center align-items-start gap-4">
                            <div className="user-image flex-shrink-0">
                              <img src="/assets/images/shop/avatar.webp" alt="" />
                            </div>
                    ...
                    <div className="mt-5 review-form">
                      ...
                      <Form className="needs-validation" noValidate>
                        ...
                        <div className="mb-5 mt-4">
                          ...
                          <textarea className="form-control rounded-0" required></textarea>
                        </div>
                        <div className="mb-5">
