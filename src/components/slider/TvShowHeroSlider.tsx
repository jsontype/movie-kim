                    ...
                    <Col lg="7" md="12">
                      ...
                      >
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-3 movie-banner-time">
                          ...
                          <span className="trending-time font-normal"> 1hr : 44mins </span>
                          <span className="font-size-6">
                            <i className="fa-solid fa-circle"></i>
                          </span>
                          <span className="trending-year font-normal"> Feb 2018 </span>
                        </div>
                        <p
                          ...
                          data-delay-in="1.2"
                        >
                          Dinosaurs are a diverse group of reptiles of the clade Dinosauria. They
                          first appeared during the Triassic period, between 243 and 233.23 million
                          years ago, although the exact origin and timing of the evolution of
                    ...
                    <Col lg="7" md="12">
                      ...
                      >
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-3 movie-banner-time">
                          ...
                          <span className="trending-time font-normal">2hr : 42mins </span>
                          <span className="font-size-6">
                            <i className="fa-solid fa-circle"></i>
                          </span>
                          <span className="trending-year font-normal"> Nov 2017 </span>
                        </div>
                        <p
                          className="movie-banner-text line-count-3"
                          data-animation-in="fadeInUp"
                          data-delay-in="1.2"
                        >
                          The most brutal emperor in the history of world.He was the founder of the
                          most contiguous empire of the world i.e. the Mongol empire.He made an army
                          by himself by uniting some nomadic tribes and trained them.
                        </p>
                      </div>
                      <div className="iq-button" data-animation-in="fadeInUp" data-delay-in="1.2">
                        <Link
                    ...
                    <Col lg="7" md="12">
                      ...
                      >
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-3 movie-banner-time">
                          ...
                          <span className="trending-time font-normal"> 2hr : 12mins </span>
                          <span className="font-size-6">
                            <i className="fa-solid fa-circle"></i>
                          </span>
                          <span className="trending-year font-normal"> Dec 2018 </span>
                        </div>
                        <p
                          className="movie-banner-text line-count-3"
                          data-animation-in="fadeInUp"
                          data-delay-in="1.2"
                        >
                          Jumbo also known as Jumbo the Elephant and Jumbo the Circus Elephant, was
                          a 19th-century male African bush elephant born in Sudan. Jumbo was
                          exported to Jardin des Plantes, a zoo in Paris, and then transferred in
                          1865 to London Zoo in England. Despite public protest, Jumbo was sold to
                          P. T. Barnum, who took him to the United States for exhibition in March
                          1882.
                        </p>
                      </div>
                      <div className="iq-button" data-animation-in="fadeInUp" data-delay-in="1.2">
